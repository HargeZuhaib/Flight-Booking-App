package com.example.flightbookingapp.Adapter;
...
import com.example.flightbookingapp.Model.Seat;
import com.example.flightbookingapp.R;
import com.example.flightbookingapp.databinding.SeatItemBinding;
...
public class SeatAdapter extends RecyclerView.Adapter<SeatAdapter.SeatViewholder> {
    ...
    public void onBindViewHolder(@NonNull SeatAdapter.SeatViewholder holder, int position) {
        ...
        holder.binding.SeatImageView.setOnClickListener(v -> {
            ...
            String selected  = selectedSeatName.toString().replace("[","")
                    .replace("]","")
                    .replace(" ","");
